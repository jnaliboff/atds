...
class Vertex(object):
    ...
    def __init__(self, key):
        ...
        """
        self.id = key
        self.connected_to = {}   # empty dictionary for neighboring 
vertices
        self.color = 'white'
        self.distance = 0
...
class Graph(object):
    ...
    def add_vertex(self, key):
        """Creates a new "key-value" dictionary entry with the string 
"key"
        key as the dictionary key, and the Vertex object itself as the 
value.
    ...
    def __contains__(self, key):
        ...
        operation: If the parameter 'key' is in the dictionary of 
vertices,
    ...
    def add_edge(self, from_key, to_key, weight=0):
        ...
        self.get_vertex(from_key).add_neighbor(self.get_vertex(to_key), 
weight)
